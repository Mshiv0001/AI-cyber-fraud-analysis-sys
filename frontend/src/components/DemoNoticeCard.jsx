...
export default function DemoNoticeCard() {
  return (
    <div className="glass-card relative overflow-hidden flex flex-col gap-4 group mt-auto" style={{ padding: '24px 22px' }}>
      ...
      {/* Header Pill */}
      <div className="flex items-center justify-between gap-2.5 relative z-10 flex-wrap">
        <div className="flex items-center gap-2.5">
          ...
          <h3 className="text-[15px] sm:text-[16px] font-bold text-[#0B1B3A] dark:text-[#F8FAFC] tracking-tight font-[family-name:var(--font-display)] leading-snug">
            Demo & Architecture Note
          </h3>
        </div>
        <span
          className="shrink-0 text-[9.5px] sm:text-[10px] font-bold px-2.5 py-1 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/25 uppercase tracking-wider leading-normal"
      ...
      <div className="relative z-10 flex items-center justify-center gap-2 flex-wrap pt-1 border-t border-white/40 dark:border-white/10" style={{ justifyContent: 'center' }}>
